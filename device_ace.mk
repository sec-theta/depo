...
$(call inherit-product-if-exists, vendor/intex/ace/ace-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/intex/ace/overlay
...
ifeq ($(TARGET_PREBUILT_KERNEL),)
    LOCAL_KERNEL := device/intex/ace/prebuilt/Image.gz-dtb
else
    LOCAL_KERNEL := $(TARGET_PREBUILT_KERNEL)
endif

#TARGET_OTA_ASSERT_DEVICE := ace

TARGET_PROVIDES_INIT_RC := true

PRODUCT_COPY_FILES += \
    device/intex/ace/rootdir/init.rc:root/init.rc \
    device/intex/ace/rootdir/init.target.rc:root/init.target.rc \
    device/intex/ace/rootdir/init.mt6735.rc:root/init.mt6735.rc \
    device/intex/ace/rootdir/init.ssd.rc:root/init.ssd.rc \
    device/intex/ace/rootdir/init.xlog.rc:root/init.xlog.rc \
    device/intex/ace/rootdir/init.usb.rc:root/init.usb.rc \
    device/intex/ace/rootdir/init.mt6735.usb.rc:root/init.mt6735.usb.rc \
    device/intex/ace/rootdir/init.aee.rc:root/init.aee.rc \
    device/intex/ace/rootdir/init.project.rc:root/init.project.rc \
    device/intex/ace/rootdir/init.modem.rc:root/init.modem.rc \
    device/intex/ace/rootdir/init.trace.rc:root/init.trace.rc \
    device/intex/ace/rootdir/fstab.mt6735:root/fstab.mt6735 \
    device/intex/ace/rootdir/fstab.swap:root/fstab.swap \
    device/intex/ace/rootdir/ueventd.rc:root/ueventd.rc \
    device/intex/ace/etc/media_codecs.xml:system/etc/media_codecs.xml \
    device/intex/ace/etc/init/audioserver.rc:system/etc/init/audioserver.rc \
    device/intex/ace/etc/init/mediacodec.rc:system/etc/init/mediacodec.rc \
    device/intex/ace/etc/init/cameraserver.rc:system/etc/init/cameraserver.rc \
    device/intex/ace/etc/init/rild.rc:system/etc/init/rild.rc \
    device/intex/ace/media_profiles.xml:system/etc/media_profiles.xml \
...
PRODUCT_COPY_FILES += \
    device/intex/ace/rootdir/etc/hostapd_default.conf:system/etc/hostapd/hostapd_default.conf \
...
# BT A2DP
#PRODUCT_COPY_FILES += \
#    vendor/intex/ace/proprietary/vendor/lib/hw/audio.a2dp.blueangel.so:system/vendor/lib/hw/audio.a2dp.mt6735.so
...
#PRODUCT_EXTRA_RECOVERY_KEYS += device/intex/ace/archos
...
#PRODUCT_MODEL := CyaniogenMod on Intex Aqua_Ace
